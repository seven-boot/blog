...
![git-workflows-gitflow](assets/git-workflows-gitflow-1559616510891.png)
...
![git-workflow-release-cycle-1historical](assets/git-workflow-release-cycle-1historical.png)
...
![git-workflow-release-cycle-2feature](assets/git-workflow-release-cycle-2feature.png)

注意，从各种含义和目的上来看，功能分支加上 develop 分支就是功能分支工作流的用法。但 GitFlow 工作流没有在这里止步。

### 发布分支

![git-workflow-release-cycle-3release](assets/git-workflow-release-cycle-3release.png)
...
![git-workflow-release-cycle-4maintenance](assets/git-workflow-release-cycle-4maintenance.png)
...
![git-workflow-release-cycle-5createdev](assets/git-workflow-release-cycle-5createdev.png)
...
![git-workflow-release-cycle-6maryjohnbeginnew](assets/git-workflow-release-cycle-6maryjohnbeginnew.png)
...
![git-workflow-release-cycle-7maryfinishes](assets/git-workflow-release-cycle-7maryfinishes.png)
...
![git-workflow-release-cycle-8maryprepsrelease](assets/git-workflow-release-cycle-8maryprepsrelease.png)
...
![git-workflow-release-cycle-9maryfinishes](assets/git-workflow-release-cycle-9maryfinishes.png)
...
![git-workflow-gitflow-enduserbug](assets/git-workflow-gitflow-enduserbug.png)
