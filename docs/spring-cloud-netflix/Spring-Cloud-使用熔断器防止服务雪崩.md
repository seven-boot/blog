...
![201805292246007](assets/201805292246007.png)

较底层的服务如果出现故障，会导致连锁故障。当对特定的服务的调用的不可用达到一个阀值（Hystrix 是 **5 秒 20 次**） 熔断器将会被打开。

![201805292246008](assets/201805292246008.png)
...
```java
package com.seven.hello.spring.cloud.web.admin.feign.service;
...
```java
package com.seven.hello.spring.cloud.web.admin.feign.service.hystrix;
