...
![201805292246003](assets/201805292246003.png)
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.seven.hello.spring.cloud.web.admin.ribbon.WebAdminRibbonApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.seven.hello.spring.cloud.web.admin.ribbon;
...
```java
package com.seven.hello.spring.cloud.web.admin.ribbon.config;
...
```java
package com.seven.hello.spring.cloud.web.admin.ribbon.service;
...
```java
package com.seven.hello.spring.cloud.web.admin.ribbon.controller;

import com.seven.hello.spring.cloud.web.admin.ribbon.service.AdminService;
import org.springframework.beans.factory.annotation.Autowired;
...
![201805292246004](assets/201805292246004.png)
...
![201805292246005](assets/201805292246005.png)

#### 步骤二

（老版本）选择需要启动多实例的项目并去掉 `Single instance only` 前面的勾

（新版本）选择需要启动多实例的项目并勾选 `Allow parallel run` 前面的勾

![201805292246006](assets/201805292246006.png)

![1559532594566](assets/1559532594566.png)
