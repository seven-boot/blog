    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.seven.hello.spring.cloud.eureka.EurekaApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.seven.hello.spring.cloud.eureka;
...
![201805292246001](assets/201805292246001.png)