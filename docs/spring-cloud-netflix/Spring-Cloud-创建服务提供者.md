    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.seven.hello.spring.cloud.service.admin.ServiceAdminApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.seven.hello.spring.cloud.service.admin;
...
```java
package com.seven.hello.spring.cloud.service.admin.controller;
...
![201805292246002](assets/201805292246002.png)
