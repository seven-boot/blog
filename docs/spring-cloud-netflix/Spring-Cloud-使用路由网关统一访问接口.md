...
![201805292246011](assets/201805292246011.png)
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.seven.hello.spring.cloud.zuul.ZuulApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.seven.hello.spring.cloud.zuul;
...
```java
package com.seven.hello.spring.cloud.zuul.fallback;
