...
![2279594-dd72907e82f89fd6](assets/2279594-dd72907e82f89fd6.png)

随着服务的越来越多，对调用链的分析会越来越复杂。它们之间的调用关系也许如下：

![2279594-4b7d1b6abe595390](assets/2279594-4b7d1b6abe595390.png)
...
![2279594-4b865f2a2c271def](assets/2279594-4b865f2a2c271def.png)
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.seven.hello.spring.cloud.zipkin.ZipKinApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.seven.hello.spring.cloud.zipkin;
...
![2018060105410001](assets/2018060105410001.png)

**刷新之前项目中的全部测试接口（刷多几次）**

点击 `Find a trace`，可以看到具体服务相互调用的数据

![2018060105410002](assets/2018060105410002.png)

点击 `Dependencies`，可以发现服务的依赖关系

![2018060105410003](assets/2018060105410003.png)
